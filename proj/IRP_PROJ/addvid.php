        ...
        <form action="/action_page.php">
          <button type="submit">SignUp</button>
		   ...
		   if ( isset( $_POST[ 'submit' ] ) ) {
			...
			$done = "
					<center>
					<div class='alert alert-success fade in _web-inspector-hide-shortcut_'' style='margin-top:10px;'>
			...
			$sql = "INSERT INTO `admin` (`Title`, `vidlink`, `Description`, ``, `Description`) VALUES ('$title','$v_url','$v_info')";
